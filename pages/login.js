				...
				<div className='flex flex-col items-center justify-center h-screen px-4 pt-2 sm:px-6 lg:px-8'>
					...
					<div className='flex flex-col w-full max-w-md mt-5 space-y-5 '>
						...
						<div className='flex flex-col space-y-4'>
							<div className='flex items-center justify-center px-4 py-2 space-x-2 transition-colors duration-300 border border-gray-800 rounded-md group hover:bg-gray-800 focus:outline-none'>
								<span>
									<svg
